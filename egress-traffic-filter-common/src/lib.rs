...
pub fn range_contains_ip(prefix: u128, range_mask: u128, ip: u128) -> bool {
...
mod tests {
  ...
  fn test_cidrv4_ipv4_local() {
    ...
    assert!(super::range_contains_ip(prefix, range_mask, ip_in));
    // outside
    let ip_out: u128 = 3232281089; // 192.168.178.1
    assert_eq!(false, super::range_contains_ip(prefix, range_mask, ip_out));
  }
